...
public class GuitarSound extends PositionWithLength {
	...
	public GuitarSound(final int position, final int length, final Mute mute, final HOPO hopo, final Harmonic harmonic,
			final boolean accent, final boolean vibrato, final boolean tremolo, final boolean linkNext,
			final Integer slideTo, final boolean unpitchedSlide, final boolean ignore) {
		super(position, length);
		this.mute = mute;
		this.hopo = hopo;
