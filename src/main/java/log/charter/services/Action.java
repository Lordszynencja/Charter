...
public enum Action {
	...
	FRET_0(Label.FRET_0, GUITAR), //
	FRET_1(Label.FRET_1, GUITAR), //
	FRET_2(Label.FRET_2, GUITAR), //
	FRET_3(Label.FRET_3, GUITAR), //
	FRET_4(Label.FRET_4, GUITAR), //
	FRET_5(Label.FRET_5, GUITAR), //
	FRET_6(Label.FRET_6, GUITAR), //
	FRET_7(Label.FRET_7, GUITAR), //
	FRET_8(Label.FRET_8, GUITAR), //
	FRET_9(Label.FRET_9, GUITAR), //
	...
	MOVE_BACKWARD(Label.MOVE_BACKWARD, TEMPO_MAP, VOCALS, GUITAR), //
	MOVE_FORWARD(Label.MOVE_FORWARD, TEMPO_MAP, VOCALS, GUITAR), //
	MOVE_FRET_DOWN(Label.MOVE_FRET_DOWN, GUITAR), //
	MOVE_FRET_UP(Label.MOVE_FRET_UP, GUITAR), //
	...
	SELECT_ALL_NOTES(Label.SELECT_ALL_NOTES, VOCALS, GUITAR), //
	...
	TOGGLE_REPEAT_END(Label.TOGGLE_REPEAT_START, GUITAR), //
	TOGGLE_REPEAT_START(Label.TOGGLE_REPEAT_END, GUITAR), //
