...
public class DefaultShortcuts extends ShortcutList {
	...
	private DefaultShortcuts() {
		...
		super.set(Action.NEXT_ITEM_WITH_SELECT, new Shortcut(KeyEvent.VK_PAGE_DOWN));
		super.set(Action.NEXT_ITEM_WITH_SELECT_CTRL, new Shortcut(KeyEvent.VK_PAGE_DOWN).ctrl());
		super.set(Action.NEXT_ITEM_WITH_SELECT_CTRL_SHIFT, new Shortcut(KeyEvent.VK_PAGE_DOWN).ctrl().shift());
		super.set(Action.NEXT_ITEM_WITH_SELECT_SHIFT, new Shortcut(KeyEvent.VK_PAGE_DOWN).shift());
		...
		super.set(Action.PREVIOUS_ITEM_WITH_SELECT, new Shortcut(KeyEvent.VK_PAGE_UP));
		super.set(Action.PREVIOUS_ITEM_WITH_SELECT_CTRL, new Shortcut(KeyEvent.VK_PAGE_UP).ctrl());
		super.set(Action.PREVIOUS_ITEM_WITH_SELECT_CTRL_SHIFT, new Shortcut(KeyEvent.VK_PAGE_UP).ctrl().shift());
		super.set(Action.PREVIOUS_ITEM_WITH_SELECT_SHIFT, new Shortcut(KeyEvent.VK_PAGE_UP).shift());
