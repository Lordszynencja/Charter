...
public class DefaultEofShortcuts extends ShortcutList {
	...
	private DefaultEofShortcuts() {
		...
		super.set(Action.FRET_0, new Shortcut(KeyEvent.VK_0));
		super.set(Action.FRET_1, new Shortcut(KeyEvent.VK_1));
		super.set(Action.FRET_2, new Shortcut(KeyEvent.VK_2));
		super.set(Action.FRET_3, new Shortcut(KeyEvent.VK_3));
		super.set(Action.FRET_4, new Shortcut(KeyEvent.VK_4));
		super.set(Action.FRET_5, new Shortcut(KeyEvent.VK_5));
		super.set(Action.FRET_6, new Shortcut(KeyEvent.VK_6));
		super.set(Action.FRET_7, new Shortcut(KeyEvent.VK_7));
		super.set(Action.FRET_8, new Shortcut(KeyEvent.VK_8));
		super.set(Action.FRET_9, new Shortcut(KeyEvent.VK_9));
