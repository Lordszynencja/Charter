...
public class DefaultEofShortcuts extends ShortcutList {
	...
	private DefaultEofShortcuts() {
		...
		super.set(Action.BOOKMARK_2, new Shortcut(KeyEvent.VK_2).shift());
		super.set(Action.BOOKMARK_3, new Shortcut(KeyEvent.VK_3).shift());
		super.set(Action.BOOKMARK_4, new Shortcut(KeyEvent.VK_4).shift());
		super.set(Action.BOOKMARK_5, new Shortcut(KeyEvent.VK_5).shift());
		super.set(Action.BOOKMARK_6, new Shortcut(KeyEvent.VK_6).shift());
		super.set(Action.BOOKMARK_7, new Shortcut(KeyEvent.VK_7).shift());
		super.set(Action.BOOKMARK_8, new Shortcut(KeyEvent.VK_8).shift());
		super.set(Action.BOOKMARK_9, new Shortcut(KeyEvent.VK_9).shift());
		...
		super.set(Action.NEXT_BEAT, new Shortcut(KeyEvent.VK_PAGE_DOWN));
		super.set(Action.NEXT_GRID, new Shortcut(KeyEvent.VK_PAGE_DOWN).ctrl().shift());
		super.set(Action.NEXT_ITEM, new Shortcut(KeyEvent.VK_PAGE_DOWN).shift());
		super.set(Action.NEXT_ITEM_TYPE, new Shortcut(KeyEvent.VK_TAB).ctrl());
		super.set(Action.NEXT_ITEM_WITH_SELECT, new Shortcut(KeyEvent.VK_PAGE_DOWN).alt());
		...
		super.set(Action.PREVIOUS_BEAT, new Shortcut(KeyEvent.VK_PAGE_UP));
		super.set(Action.PREVIOUS_GRID, new Shortcut(KeyEvent.VK_PAGE_UP).ctrl().shift());
		super.set(Action.PREVIOUS_ITEM, new Shortcut(KeyEvent.VK_PAGE_UP).shift());
		super.set(Action.PREVIOUS_ITEM_TYPE, new Shortcut(KeyEvent.VK_TAB).ctrl().shift());
		super.set(Action.PREVIOUS_ITEM_WITH_SELECT, new Shortcut(KeyEvent.VK_PAGE_UP).alt());
		...
		super.set(Action.STRING_1, new Shortcut(KeyEvent.VK_1).ctrl());
		super.set(Action.STRING_2, new Shortcut(KeyEvent.VK_2).ctrl());
		super.set(Action.STRING_3, new Shortcut(KeyEvent.VK_3).ctrl());
		super.set(Action.STRING_4, new Shortcut(KeyEvent.VK_4).ctrl());
		super.set(Action.STRING_5, new Shortcut(KeyEvent.VK_5).ctrl());
		super.set(Action.STRING_6, new Shortcut(KeyEvent.VK_6).ctrl());
		super.set(Action.STRING_7, new Shortcut(KeyEvent.VK_7).ctrl());
		super.set(Action.STRING_8, new Shortcut(KeyEvent.VK_8).ctrl());
		super.set(Action.STRING_9, new Shortcut(KeyEvent.VK_9).ctrl());
		...
		super.set(Action.TOGGLE_SLAP_POP_INDEPENDENTLY, new Shortcut(KeyEvent.VK_P).shift());
