...
public class ActionHandler implements Initiable {
	...
	public void init() {
		...
		actionHandlers.put(Action.TOGGLE_POP_SLAP, guitarSoundsStatusesHandler::toggleMute);
		actionHandlers.put(Action.TOGGLE_POP_SLAP_INDEPENDENTLY, guitarSoundsStatusesHandler::toggleMuteIndependently);
