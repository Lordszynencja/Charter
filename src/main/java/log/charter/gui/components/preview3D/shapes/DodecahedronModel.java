...
public class DodecahedronModel implements Model {
	public static DodecahedronModel instance = new DodecahedronModel();
	...
	static {
		...
		for (int i = 0; i < 3; i++) {
			points.add(levelPoints[0][0]);
			points.add(levelPoints[0][1 + i]);
			points.add(levelPoints[0][2 + i]);
		}
		...
		for (int i = 0; i < 5; i++) {
			points.add(levelPoints[0][(i + 1) % 5]);
			points.add(levelPoints[1][i]);
			points.add(levelPoints[1][(i + 1) % 5]);
		}
		...
		for (int i = 0; i < 5; i++) {
			points.add(levelPoints[2][(i + 1) % 5]);
			points.add(levelPoints[3][i]);
			points.add(levelPoints[3][(i + 1) % 5]);
		}

		for (int i = 0; i < 3; i++) {
			points.add(levelPoints[3][0]);
			points.add(levelPoints[3][1 + i]);
			points.add(levelPoints[3][2 + i]);
		}
	}
