...
public interface DrawableShape {
	...
	public static DrawableShape filledRoundRectangle(final ShapePositionWithSize position, final Color color,
			final int arc) {
		return new FilledRoundRectangle(position, color, arc);
	}
