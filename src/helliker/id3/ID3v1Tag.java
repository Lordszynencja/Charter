...
public class ID3v1Tag implements ID3Tag {
	 ...
	 * the information is automatically extracted. Supports only id3v1.1 directly
	 * but id3v1.0 tags will most likely work correctly too.
	 * 
	...
	private byte[] getFieldBytes(final String str, final int length)
	 ...
	 *           the open file to read from
	 */
	private void readTag(final RandomAccessFile raf)
			throws FileNotFoundException, IOException {
	...
	public void removeTag() throws FileNotFoundException, IOException {
		if (headerExists) {
			...
			try {
				...
				final Long bufSize = new Long(raf.length() - TAG_SIZE);
	...
	/**
	 * Set the album field of the tag. The maximum size of the String is 30. If
	 * the size exceeds the maximum size, the String will be truncated.
	 * 
	 * @param newAlbum
	 *           the album for the tag
	 */
	...
	/**
	 * Set the artist field of the tag. The maximum size of the String is 30. If
	 * the size exceeds the maximum size, the String will be truncated.
	 * 
	 * @param newArtist
	 *           the artist for the tag
	 */
	...
	/**
	 * Set the genre field of the tag. This probably should not be greater than
	 * 115, but supports values from 0-255.
	 * 
	 * @exception ID3FieldDataException
	 *               if the value supplie is invalid
	 * @param newGenre
	...
	/**
	 * Set the title field of the tag. The maximum size of the String is 30. If
	 * the size exceeds the maximum size, the String will be truncated.
	 * 
	 * @param newTitle
	 *           the title for the tag
	 */
	...
	/**
	 * Set the track field of the tag. The track number has to be between 0 and
	 * 255. If it is not, nothing will happen.
	 * 
	 * @param newTrack
	 *           the track of the tag
	 */
